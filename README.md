...
*Download* all files mentioned as script1 - overlapped_ids.py ,  overlapped_ids_h.py, overlapped_ids_m.py, clean_ov_ids.py, clean_ov_ids_h.py, clean_ov_ids_m.py, clean_ov_ids_h-m.py, reciprocal_mac-hum.py - AND the bash script named script_all.sh .<br/>
