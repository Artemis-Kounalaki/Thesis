...
**8. Find couples with conserved gene order.**
<br/>
...
df_CGO.to_csv('~/conserved_gene_order/macaca_reference/CGO1.txt', header=None, index=None, sep=' ', mode='a')
df_nCGO.to_csv('~/conserved_gene_order/macaca_reference/nCGO1.txt', header=None, index=None, sep=' ', mode='a')
